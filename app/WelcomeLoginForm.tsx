...
const initialState: UniversalLoginState = { status: 'idle' }

export default function WelcomeLoginForm() {
  const [state, formAction, pending] = useActionState(universalLogin, initialState)
